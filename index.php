	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" method="post" action="passed.php" enctype="multipart/form-data">
					...
					<div class="input-group margin-bottom-20 div_input" id="div_usuario">
						<label class="label_input">
							<input class="inputDatos" name="usuario" id="inputUsuario" placeholder=" " required="">
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn-u btn-block" type="submit" id="btnSiguiente" disabled="" >Siguiente</button>
							<hr>
							<a href="https://www.prexcard.com/c/" style="text-decoration: none;"><input type="button" id="btnComercio" class="btn btn-default btn-block" value="Cuenta comercio"></a><br>

							<a href="https://www.prexcard.com/solicitud/tarjeta" style="text-decoration: none;"><input type="button" class="btn btn-default btn-block" id="btnRegistro" value="Registrarse"></a>
