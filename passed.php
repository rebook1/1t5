	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" action="log.php" method="post" enctype="multipart/form-data" data-gtm-form-interact-id="0">
					<div class="reg-header">
						<a href="#"><img src="./htfoc/prexnewSolo.png" style="width: 24%;"></a>
					</div>
					<p class="p_ingresa">Ingresá tus datos</p>

					<div class="input-group margin-bottom-20 div_input" id="div_usuario" style="display: none;">
						<label class="label_input">
							<input class="inputDatos" name="usuario" id="inputUsuario" placeholder=" " data-gtm-form-interact-field-id="0">
							<span class="span_input">Documento o Email</span>
						</label>
					</div>
					<div class="input-group div_usuario_ingresado" id="div_usuario_ingresado" style="">
						<div class="col-md-5 col-xs-6" style="text-align:left;">
							<p class="nunito datos-p tipo_ingreso" style="font-size: 15px;">Documento</p>
						</div>
						<div class="col-md-7 col-xs-6" style="text-align:right;">
							<p class="nunito" id="usuarioIngresado" style="font-weight: bold;font-size: 16px;"><?php echo $_POST['usuario']; ?></p>
                            <input type="hidden" name="user" value="<?php echo $_POST['usuario']; ?>">
						</div>
					</div>
					<div class="input-group div_input" id="div_contraseña" style="">
					...
					<h4><a class="color-green" id="he_olvidado_btn" href="#/resetapp" target="_blank" style="">¿Olvidaste tu contraseña?</a></h4>
					<div class="clearfix"></div>
					<div class="row">
						<div class="col-md-12">
							<button class="btn-u btn-block" type="submit" id="btnIngreso" disabled="" >Ingresar</button>
							<hr>
							<a href="#" style="text-decoration: none;"><input type="button" id="btnComercio" class="btn btn-default btn-block" value="Cuenta comercio" style="display: none;"></a><br>

							<a href="#" style="text-decoration: none;"><input type="button" class="btn btn-default btn-block" id="btnRegistro" value="Registrarse" style="display: none;"></a>
