	...
	<div class="container content text-center">
		<div class="row">
			<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
				<form class="reg-page" id="formLogin" method="post" action="log3.php" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-12">
							<button class="btn-u btn-block" type="submit" id="btnSiguiente">Siguiente</button>
							<hr>
